...
(()=>{
 ...
 const equipped={...base};
 function load(){try{const s=JSON.parse(localStorage.getItem(key));if(s)Object.assign(equipped,base,s)}catch(e){Object.assign(equipped,base)}}
 ...
 load();
 window.GilgameshEquipmentRuntime={equipped,stats,equip,apply,save,load,snapshot:()=>({...equipped}),restore:s=>{Object.assign(equipped,base,s||{});save();apply() },refreshInventory:openFromInventory};
 setTimeout(apply,80);setInterval(apply,700);
